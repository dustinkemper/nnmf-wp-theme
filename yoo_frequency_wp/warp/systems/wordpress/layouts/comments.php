        ...
        <?php if (have_comments()) : ?>
            ...
            <?php
                ...
                function mytheme_comment($comment, $args, $depth)
                {
                    ...
                    $warp = require(dirname(dirname(dirname(dirname(__DIR__)))).'/warp.php');
    ...
    <script type="text/javascript">
        ...
        jQuery(function($) {
            ...
            $("p.js-reply > a").bind("click", function(){
                ...
                $('<a><?php echo __("Cancel");?></a>').addClass('comment-cancelReply').attr('href', "#respond").bind("click", function(){
                    respond.find(".comment-cancelReply:first").remove();
